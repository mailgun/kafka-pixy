...
func NewOffsetManagerFromClient(client sarama.Client) (OffsetManager, error) {
	...
	om := &offsetManager{
		baseCID:  context.RootID.NewChild("offsetManager"),
		client:   client,
...
func (om *offsetManager) resolveBroker(pw partitionWorker) (*sarama.Broker, error) {
...
func (pom *partitionOffsetMgr) processCommits() {
	...
	var (
		...
		commitTimeout             = 3 * pom.om.config.Consumer.Offsets.CommitInterval
	)
...
func (pom *partitionOffsetMgr) fetchInitialOffset(conn *sarama.Broker) (DecoratedOffset, error) {
...
func (pom *partitionOffsetMgr) getCommitError(res *sarama.OffsetCommitResponse) error {
...
func (om *offsetManager) spawnBrokerExecutor(brokerConn *sarama.Broker) brokerExecutor {
	bom := &brokerOffsetMgr{
...
func (bom *brokerOffsetMgr) brokerConn() *sarama.Broker {
	return bom.conn
}
